...
/**
 * The arguments resolver class for retrieving value from TransportEvent.
 *
...
@Component(
	immediate = true,
	service = {
		TransportEventModelArgumentsResolver.class, ArgumentsResolver.class
	}
)
public class TransportEventModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		if (!checkColumn || (columnBitmask == 0)) {
			return _getValue(transportEventModelImpl, columnNames, original);
		}
	...
	public String getClassName() {
		return TransportEventImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return TransportEventTable.INSTANCE.getTableName();
	}

	private static Object[] _getValue(
		TransportEventModelImpl transportEventModelImpl, String[] columnNames,
		boolean original) {
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				arguments[i] = transportEventModelImpl.getColumnOriginalValue(
					columnName);
			}
			else {
